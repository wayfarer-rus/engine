...
int main(void)
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// printf("%i %f\n", base, delta);
		glTranslatef(-0.5f, -0.7f + delta, 0);
		...
		glBegin(GL_QUADS);
		glTexCoord2f(0, 0); glVertex3f(0+delta/2, 1.0f, 0);
		glTexCoord2f(0, 1.0f); glVertex3f(0+delta/2, 0, 0);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1.0f-delta/2, 0, 0);
		glTexCoord2f(1.0f, 0); glVertex3f(1.0f-delta/2, 1.0f, 0);
		glEnd();
