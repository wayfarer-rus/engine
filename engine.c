/*****************************************************************************
 * For ubuntu:
 *   gcc boing.c -lglfw3 -lXi -lXrandr -lGLU -llua5.2 -I/usr/include/lua5.2
 *
 * This is a combination of code from glfw3 example plus code for Lua integration.
 *****************************************************************************/
...
int main(void) {
	...
	lua_register(L, "displayLua", displayLua);
